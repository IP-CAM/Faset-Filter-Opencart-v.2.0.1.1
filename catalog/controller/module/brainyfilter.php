...
//            }
        ...
        if (!isset($this->request->get['route']) 
            ...
            $this->_data['redirectToUrl'] = $this->url->link('product/category', (isset($this->request->get['path'])) ? 'path=' . $this->request->get['path'] : '');
        } else {
        ...
        if($this->_data['currentRoute']=="common/home" || $this->_data['currentRoute'] == "")
        {
            $this->_data['settings']['submission']['submit_type'] = 'partlyRefresh';
        }
