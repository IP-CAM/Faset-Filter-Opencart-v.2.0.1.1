...
//            ->distinct()
        ...
        //Костыль, для того, что бы вывалить все категории в список фильтра
        //вывал всех типов автомобиля, без него в фильтре отображаеться только тип
        //которые характерен данной категории
...
//            ->distinct()
        ...
        if (count($res->rows)) {
            foreach ($res->rows as $row) {
                    ...
                    /*Костыль для выбора категории после поиска на главной,
                    если в фильтре на главной выбран пункт "легковые" то редирект будет
                    на страницу "Шины" , если грузовые то на страницу "Грузовые шины"

                    я подставляю id категории с шинами или с грузовыми шинами в зависимости от
                    выбранного авто в фильтре
                    */
                    switch($r['id'])
                    {
                        case 14:{
